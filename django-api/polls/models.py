...
class PollCharFieldAnswer(models.Model):
    ...
    field = models.ForeignKey(PollCharField, on_delete=models.CASCADE)
...
class PollTextFieldAnswer(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    field = models.ForeignKey(PollTextField, on_delete=models.CASCADE)
...
class PollChoiceFieldAnswer(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    field = models.ForeignKey(PollChoiceField, on_delete=models.CASCADE)
...
class PollMultiChoiceFieldAnswer(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    field = models.ForeignKey(PollMultiChoiceField, on_delete=models.CASCADE)
