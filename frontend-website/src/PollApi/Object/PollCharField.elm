...
module PollApi.Object.PollCharField exposing (..)
...
id : SelectionSet PollApi.ScalarCodecs.Id PollApi.Object.PollCharField
id =
    Object.selectionForField "ScalarCodecs.Id" "id" [] (PollApi.ScalarCodecs.codecs |> PollApi.Scalar.unwrapCodecs |> .codecId |> .decoder)


text : SelectionSet String PollApi.Object.PollCharField
text =
...
charFieldAnswers :
    ...
    -> SelectionSet (List decodesTo) PollApi.Object.PollCharField
charFieldAnswers object____ =
    Object.selectionForCompositeField "charFieldAnswers" [] object____ (Basics.identity >> Decode.list)
